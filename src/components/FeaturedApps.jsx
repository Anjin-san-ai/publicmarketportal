import { CheckCircle, Users, Star, Info, Rocket, ArrowRight } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="flex items-end justify-between mb-12">
          <div>
            ...
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Featured AI Solutions</h2>
            <p className="text-lg text-gray-600">
              Popular and recommended applications across departments.
            </p>
          </div>
